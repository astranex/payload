...
const EditView = (props) => {
    ...
    const {
        ...
        admin: {
            useAsTitle,
            components: { views: { Edit: CustomEdit } = {} } = {}
        } = {}
    } = incomingCollection;
    const [fields] = useState(() =>
        formatFields(incomingCollection, isEditing)
    );
    ...
    const dataToRender =
        (locationState === null || locationState === void 0
            ? void 0
            : locationState.data) || data;
    useEffect(() => {
        const nav = [
            {
    ...
    const hasSavePermission =
        (isEditing &&
            ((_b =
                ...
                collectionPermissions === void 0
                    ? void 0
                    : collectionPermissions.update) === null || _b === void 0
                ? void 0
                : _b.permission)) ||
        (!isEditing &&
            ((_c =
                ...
                collectionPermissions === void 0
                    ? void 0
                    : collectionPermissions.create) === null || _c === void 0
                ? void 0
                : _c.permission));
    return React.createElement(RenderCustomComponent, {
