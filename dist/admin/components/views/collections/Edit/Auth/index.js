...
const Auth = (props) => {
    ...
    return (React.createElement("div", { className: baseClass },
        ...
        (changingPassword || requirePassword) && (React.createElement("div", { className: `${baseClass}__changing-password` },
            ...
            !requirePassword && (React.createElement(Button, { size: "small", buttonStyle: "secondary", onClick: () => handleChangePassword(false) }, "Cancel")))),
        (!changingPassword && !requirePassword) && (React.createElement(Button, { size: "small", buttonStyle: "secondary", onClick: () => handleChangePassword(true) }, "Change Password")),
