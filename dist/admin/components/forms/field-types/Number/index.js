...
const NumberField = (props) => {
    ...
    return (React.createElement("div", { className: classes, style: {
        ...
        React.createElement("input", { id: `field-${path.replace(/\./gi, '__')}`, value: typeof value === 'number' ? value : '', onChange: handleChange, disabled: readOnly, placeholder: placeholder, type: "number", name: path, step: step, onWheel: (e) => {
