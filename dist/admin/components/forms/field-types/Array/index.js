...
const ArrayFieldType = (props) => {
    ...
    const {
        ...
        minRows,
        permissions,
        admin: { readOnly, description, condition, className }
    } = props;
    const path = pathFromProps || name;
    // Handle labeling for Arrays, Global Arrays, and Blocks
    const getLabels = (p) => {
        if (p === null || p === void 0 ? void 0 : p.labels) return p.labels;
    ...
    const label =
        (_a = props === null || props === void 0 ? void 0 : props.label) !==
            null && _a !== void 0
            ? _a
            : (_b =
                  props === null || props === void 0
                      ? void 0
                      : props.labels) === null || _b === void 0
            ? void 0
            : _b.singular;
    ...
    const setCollapse = useCallback(
        async (rowID, collapsed) => {
            var _a, _b, _c;
            dispatchRows({ type: 'SET_COLLAPSE', id: rowID, collapsed });
            if (preferencesKey) {
                const preferencesToSet = (await getPreference(
                    preferencesKey
                )) || { fields: {} };
                let newCollapsedState =
                    ((_b =
                        (_a =
                            preferencesToSet === null ||
                            preferencesToSet === void 0
                                ? void 0
                                : preferencesToSet.fields) === null ||
                        _a === void 0
                            ? void 0
                            : _a[path]) === null || _b === void 0
                        ? void 0
                        : _b.collapsed.filter((filterID) =>
                              rows.find((row) => row.id === filterID)
                          )) || [];
                if (!collapsed) {
                    ...
                    (_b =
                        (_a =
                            preferences === null || preferences === void 0
                                ? void 0
                                : preferences.fields) === null || _a === void 0
                            ? void 0
                            : _a[path]) === null || _b === void 0
                        ? void 0
                        : _b.collapsed
    ...
    const hasMaxRows =
        maxRows &&
        (rows === null || rows === void 0 ? void 0 : rows.length) >= maxRows;
    const classes = ['field-type', baseClass, className]
        .filter(Boolean)
        .join(' ');
    if (!rows) return null;
    return React.createElement(
        ...
        React.createElement(
            'div',
            { id: `field-${path.replace(/\./gi, '__')}`, className: classes },
            React.createElement(
                'div',
                    ...
                    React.createElement(
                        ...
                        (rows.length < minRows ||
                            ...
                            React.createElement(
                                Banner,
                                { type: 'error' },
                                'Это поле требует, по крайней мере',
                                ' ',
                                minRows
            ...
            !readOnly &&
                ...
                React.createElement(
                    'div',
                    { className: `${baseClass}__add-button-wrap` },
                    React.createElement(
                        Button,
                        {
