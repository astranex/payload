...
const SortableMultiValue = SortableElement((props) => {
    ...
    const classes = [props.className, !props.isDisabled && 'draggable']
        .filter(Boolean)
        .join(' ');
    return React.createElement(components.MultiValue, {
        ...props,
        className: classes,
...
const SortableMultiValueLabel = SortableHandle((props) =>
    React.createElement(components.MultiValueLabel, { ...props })
);
...
const ReactSelect = (props) => {
    ...
    if (isMulti && isSortable) {
        return React.createElement(SortableSelect, {
            useDragHandle: true,
