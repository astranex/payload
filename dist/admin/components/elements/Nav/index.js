        ...
        React.createElement("div", { className: `${baseClass}__scroll` },
            ...
            React.createElement("div", { className: `${baseClass}__wrap` },
                Array.isArray(beforeNavLinks) &&
                    beforeNavLinks.map((Component, i) => (React.createElement(Component, { key: i }))),
                React.createElement("span", { className: `${baseClass}__label` }, "\u041A\u043E\u043B\u043B\u0435\u043A\u0446\u0438\u0438"),
                React.createElement("nav", null, collections &&
                ...
                globals && globals.length > 0 && (React.createElement(React.Fragment, null,
                    React.createElement("span", { className: `${baseClass}__label` }, "\u0413\u043B\u043E\u0431\u0430\u043B\u044C\u043D\u044B\u0435"),
                ...
                Array.isArray(afterNavLinks) &&
                    afterNavLinks.map((Component, i) => (React.createElement(Component, { key: i }))),
