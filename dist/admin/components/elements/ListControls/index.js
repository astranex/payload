...
const ListControls = (props) => {
    ...
    const shouldInitializeWhereOpened = validateWhereQuery(
        params === null || params === void 0 ? void 0 : params.where
    );
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(WhereBuilder, {
                collection: collection,
                modifySearchQuery: modifySearchQuery,
                handleChange: handleWhereChange
            })
        ...
        enableSort &&
            React.createElement(
                ...
                React.createElement(SortComplex, {
                    modifySearchQuery: modifySearchQuery,
                    collection: collection,
